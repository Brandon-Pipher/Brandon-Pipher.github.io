...
## Books
<!-- Statistics -->
- {{< ref title="All of Statistics" by="Wasserman" url="https://a.co/d/0el1N23w" >}}
...
- {{< ref title="Statistical Inference" by="Casella Berger" url="https://a.co/d/0dDVRDgH" >}}
...
- {{< ref title="Elements of Statistical Learning" by="" url="https://hastie.su.domains/ElemStatLearn/" >}}
...
- {{< ref title="An Introduction to Statistical Learning" by="" url="https://www.statlearning.com/" >}}
...
- {{< ref title="Forecasting: Principles and Practice" by="Hyndman" url="https://otexts.com/fpp3/" >}}
  ...
  - There is a python version: [FPP: The Pythonic Way](https://otexts.com/fpppy/)
  {{< /ref >}}

- {{< ref title="Trustworthy Online Controlled Experiments" by="Kohavi" url="https://a.co/d/01LvpEsj" >}}
...
<!-- Machine Learning -->
- {{< ref title="Machine Learning with PyTorch and Scikit-Learn" by="Raschka" url="https://a.co/d/0hAvMxoc" >}}
...
<!-- Bayesian -->
- {{< ref title="Bayesian Data Analysis" by="Gelman" url="https://a.co/d/03Pf3djU" >}}
...
- {{< ref title="Data Analysis Using Regression and Multilevel/Hierarchical Models" by="Gelman" url="https://a.co/d/01GlqRGc" >}}
...
- {{< ref title="Doing Bayesian Data Analysis" by="Kruschke" url="https://a.co/d/0daSkk59" >}}
  - The puppy book!
  - A highly accessible introduction to Bayesian inference.
  - [PyMC](https://www.pymc.io/projects/docs/en/latest/learn/books.html)-based adaptations are available.
  - Ideal for readers new to Bayesian thinking.
  {{< /ref >}}

<!-- Data Science -->
- {{< ref title="Ace the Data Science Interview" by="Singh" url="https://a.co/d/0aOkLgEh" >}}
...
## Videos
- {{< ref title="Neural Networks: Zero to Hero" by="Andrej Karpathy" url="https://www.youtube.com/watch?v=VMj-3S1tku0&list" >}}
  - Great practical build-up from micrograd to GPT-style training.
  - Created by the co-founder of OpenAI.
  {{< /ref >}}

## Web
- {{< ref title="StrataScratch" by="" url="https://www.stratascratch.com/" >}}
  - LeetCode for data science.
  - Good way to stay sharp on data structures, pandas, pyspark, SQL, and more.
  {{< /ref >}}

- {{< ref title="LeetCode" by="" url="https://leetcode.com/" >}}
...
- {{< ref title="On Computable Numbers, with an Application to the Entscheidungsproblem (1936)" by="A. M. Turing" url="" >}}
  - The turing machine itself.
  {{< /ref >}}

- {{< ref title="Foundations of the Theory of Probability (1933)" by="Andrey Kolmogorov" url="" >}}
  - Axioms of probability.
  {{< /ref >}}

- {{< ref title="Regression Shrinkage and Selection via the Lasso (1996)" by="Robert Tibshirani" url="" >}}
  - The LASSO!
  {{< /ref >}}

- {{< ref title="Attention Is All You Need (2017)" by="Ashish Vaswani et al." url="" >}}
  - Transformer models!
  {{< /ref >}}

- {{< ref title="On the Mathematical Foundations of Theoretical Statistics (1922)" by="R. A. Fisher" url="" >}}
